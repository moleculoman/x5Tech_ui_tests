...
## [<img src="media/logo/Jenkins.svg" width="40" height="40" alt="Jenkins"> Запуск тестов в Jenkins](https://jenkins.autotests.cloud/job/moleculoman_hw/)

### Локальный запуск
```bash
gradle clean X5TechTests
```
